...
Dr. Love reserves the right to change these Project B instructions substantially at any time before the middle of March 2025. Do not treat these Project B instructions as complete or trustworthy until this note disappears (probably in early March), **and** Dr. Love announces that the Project B instructions are final in class.
...
1. **Proposal Form** By the deadline on the [Calendar](calendar.qmd) in early April, you will submit a Google Form that Dr. Love will make available later this semester. 
...
2. **Presentation** After receiving our approval of your submitted form, you will prepare a portfolio of your results with Quarto ([a template is available](#template-for-the-portfolio) for this), and then present your work to Professor Love. The schedule for these presentations will be determined after completion of the Project B Proposal Form.
...
The Project B Proposal Form is a Google Form to be posted later this term. The form allows you to:
...
1. Have you made a reasonable choice of strategy here? (Bayesian model, Selecting Candidates via the LASSO, using survey weights, quantile regression or robust linear model?) Why did you select this approach - how does it tie in with your research question?
