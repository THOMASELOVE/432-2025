...
- The main reason why we don't approve projects is that we don't understand the description of your data set or its outcomes, your planned modeling approaches, or how the research questions link to the available data, so focus on making those connections as clear as possible.
...
6. Does your presentation focus on important issues? [See the list in the instructions](https://thomaselove.github.io/432-2025/projB.html#the-presentation).
