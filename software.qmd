...
pkgs <- c(  "afex", "aplpack", "aplore3", "arm", "babynames", "bayestestR",
            "bestglm", "boot", "car", "caret", "cowplot", "cutpointr",
            ...
            "markdown", "MASS", "mdsr", "mgcv", "mice", "mitml", "MKinfer",
            "modelsummary", "moderndive", "mosaic", "multcomp", "naniar", 
            "NHANES", "nnet", "palmerpenguins", "party", "patchwork", 
            "posterdown", "pROC", "PropCIs", "pscl", "psych", "pwr", "qcc", 
            "QuantPsyc", "quantreg", "ResourceSelection", "rmarkdown", 
            "rmdformats", "rms", "robustbase", "ROCR", "rpart", "rpart.plot",
            "rstanarm", "rstatix", "sandwich", "simputation", "spelling", 
            "styler", "summarytools", "survival", "survminer", "tableone", 
            "tidymodels", "tidytext", "tidyverse", "usethis", "vcd", "VGAM", 
            "viridis", "visdat", "xfun")
