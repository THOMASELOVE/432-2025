...
pkgs <- c(  "afex", "aplpack", "aplore3", "arm", "babynames", "bayestestR",
            "bestglm", "boot", "broom", "car", "caret", "cowplot",
            "cutpointr", "DataExplorer", "DescTools", "devtools",
            "distributions3", "Epi", "exact2x2", "ez", "faraway",
            "fivethirtyeight", "foreign", "gapminder", "gee", "geepack",
            "GGally", "ggdist", "ggforce", "ggrepel", "ggridges",
            "ggstance", "ggthemes", "glmnet", "glue", "gmodels", "gratia",
            "gridExtra", "gt", "gtExtras", "gtsummary", "here", "Hmisc",
            "HSAUR", "infer", "insight", "janitor", "kableExtra", "knitr",
            "lars", "lattice", "leaps", "lmboot", "lme4", "lmerTest",
            "lmtest", "lvplot", "magrittr", "markdown", "MASS", "mdsr",
            "mgcv", "mice", "mitml", "MKinfer", "modelsummary",
            "moderndive", "mosaic", "multcomp", "naniar", "NHANES",
            "nhanesA", "nnet", "palmerpenguins", "party", "patchwork",
            "posterdown", "pROC", "PropCIs", "pscl", "psych", "pwr", 
            "qcc", "QuantPsyc", "quantreg", "ResourceSelection",
            "rmarkdown", "rmdformats", "rms", "robustbase", "ROCR", "rpart",
            "rpart.plot", "rstanarm", "rstatix", "sandwich", "sessioninfo", 
            "simputation", "spelling", "styler", "summarytools", "survival",
            "survminer", "tableone", "tidymodels", "tidytext", "tidyverse",
