...
a. {6} Produce two proportional odds logistic regression models. The first, which I'll call `fit3a`, should use all three predictors to predict `health`, while the second model, called `fit3b`, should use only two predictors, leaving out age. In each case, interpret the meaning of the point estimate for waist circumference.
