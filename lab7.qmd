...
c. {4} Use `mod1` to make a prediction for Cuyahoga County, in Ohio, based on Cuyahoga's values for `food_env` (6.7) and for `obesity` (28) and then, in a complete sentence, compare the prediction to the observed `unemp` for Cuyahoga County as reported in 2013 as part of CHR 2015.
