...
a. {6} Plot appropriate Kaplan-Meier estimates of the survival functions for each of the two treatments in a single plot. Include a p value for the log rank test of the difference between the two survival function estimates shown in your plot. What conclusions can you draw from your plot?
