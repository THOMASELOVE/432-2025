...
1. A main effects model contains only main effects. **Question 4** is asking you to fit a model with four specified main effects included, not to look around for other potential models, identify subsets of interest, or consider things other than main effects. There are numerous places, including (but not limited to) the model called `fit13a` in **Question 14**, and the model in **Question 20**, where my instructions tell you precisely which model to fit. - *posted 2025-02-28*

2. When partitioning with a requirement for a certain distribution of a variable, the split the computer creates may wind up one or two numbers away from the ideal sizes of your training and testing samples, in order to maintain the closeness of the variable distributions. That's OK. Being within one or two people of 175 in the training group and within one or two people of 50 in the testing group in **Question 11** is fine, and is what happens in my answer sketch for the Quiz. - *posted 2025-02-28*

3. Power is virtually always expressed as a percentage, between 0 and 100. In **Question 17**, you should express power in that fashion, with zero decimal places. So, for example, if the calculated power was 0.53, your answer would be 53. - *posted 2025-02-28*

4. The original version of the [Google Form Answer Sheet](https://bit.ly/432-2025-quiz1-answer-sheet) had no place to respond to Question 7b, and forced a single choice instead of allowing multiple choices for Question 16. This is now fixed. - *posted 2025-02-28*

5. The original version of the 432 Quiz 1 PDF included three references to dates in 2024, which should have indicated 2025 instead. I posted a new version of the 432 Quiz 1 PDF to our Shared Drive that fixes these dates, and also provides a footnote related to item 2 above (in Question 11) and adds a phrase in Question 17 referring to item 3 above. - *posted 2025-03-03*
