...
b. {15} Provide a written explanation of your findings, in complete sentences. Your explanation should address all of the following:
...
a. {5} Again using the data in `hbp_3024.xlsx`, which of the seven practices has the largest mean number of visits for primary care in the past two years? Show how you figured this out using R.
